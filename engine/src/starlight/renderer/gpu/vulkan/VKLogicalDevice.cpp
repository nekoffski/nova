...
//     m_handle(VK_NULL_HANDLE), m_graphicsCommandPool(VK_NULL_HANDLE) {
...
// VKPhysicalDevice::SwapchainSupportInfo VKLogicalDevice::getSwapchainSupport()
// const {
...
//     VK_STRUCTURE_TYPE_DEVICE_CREATE_INFO; deviceCreateInfo.queueCreateInfoCount =
//     queueCreateInfos.size(); deviceCreateInfo.pQueueCreateInfos       =
//     queueCreateInfos.data(); deviceCreateInfo.pEnabledFeatures        =
//     &deviceFeatures; deviceCreateInfo.enabledExtensionCount   =
//     extensionNames.size(); deviceCreateInfo.ppEnabledExtensionNames =
//     extensionNames.data();
