...
//     );
//     void createDepthAttachment(VkFormat depthFormat, VKRenderPass::Properties
//     props); void createSubpass(); void createRenderPassDependencies(); void
...
//   VKContext& context, VKLogicalDevice& device, const VulkanSwapchain& swapchain,
...
//       m_device.getHandle(), &createInfo.handle, m_context.getAllocator(),
//       &m_handle
//     ));
...
//     auto VulkanBuffer = static_cast<VulkanCommandBuffer*>(&commandBuffer);

//     vkCmdBeginRenderPass(
//       VulkanBuffer->getHandle(), &beginInfo, VK_SUBPASS_CONTENTS_INLINE
//     );
//     VulkanBuffer->setState(VulkanCommandBuffer::State::inRenderPass);
// }

// void VKRenderPass::end(CommandBuffer& commandBuffer) {
//     auto VulkanBuffer = static_cast<VulkanCommandBuffer*>(&commandBuffer);
//     vkCmdEndRenderPass(VulkanBuffer->getHandle());
//     VulkanBuffer->setState(VulkanCommandBuffer::State::recording);
// }
...
//         m_colorAttachmentReference.attachment = m_attachmentDescriptions.size() -
//         1; m_colorAttachmentReference.layout =
//         VK_IMAGE_LAYOUT_COLOR_ATTACHMENT_OPTIMAL; m_subpass.colorAttachmentCount
//         = 1; m_subpass.pColorAttachments       = &m_colorAttachmentReference;
//     } else {
...
//         m_depthAttachmentReference.attachment = m_attachmentDescriptions.size() -
//         1; m_depthAttachmentReference.layout     = VK_IMAGE_LAYOUT_GENERAL;
...
// ) {
//     bool clearDepth = isFlagEnabled(props.clearFlags,
