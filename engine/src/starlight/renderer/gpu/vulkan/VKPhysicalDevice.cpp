...
//     ASSERT(
//       m_handle,
//       "Could not pick suitable device for vulkan, no GPU or it doesn't provide all
//       necessary features"
//     );
...
// VKPhysicalDevice::SwapchainSupportInfo
// VKPhysicalDevice::queryDeviceSwapchainSupport(
...
//             && (properties.memory.memoryTypes[i].propertyFlags &
...
//   VkPhysicalDevice device, const DeviceProperties& properties, const DeviceInfo&
//   info
// ) {
