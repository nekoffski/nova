...
// ) {
//     // TODO: shouldn't it be a part of VulkanBuffer class?
...
//       m_context, m_device,
//       VulkanBuffer::Properties{ size, flags, VK_BUFFER_USAGE_TRANSFER_SRC_BIT,
//       true }
//     );
...
// void VKMesh::upload(
//   VulkanBuffer& vertexBuffer, VulkanBuffer& indexBuffer, const Data& data
// ) {
