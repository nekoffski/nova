...
// VKImage::VKImage(
//   VKContext& context, VKLogicalDevice& device, const Texture::ImageData&
//   imageData, VkImage handle
// ) :
//     m_context(context), m_device(device), m_imageData(imageData),
//     m_handle(handle), m_memory(VK_NULL_HANDLE), m_view(VK_NULL_HANDLE),
//     m_destroyImage(false) { createView();
// }
...
//     VulkanBufferUsageFlags usage = VK_BUFFER_USAGE_TRANSFER_SRC_BIT;
//     VkMemoryPropertyFlags memoryProps =
//       VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT;

//     VulkanBuffer::Properties stagingBufferProperties{
//         .size                = imageSize,
...
//     VulkanBuffer stagingBuffer(m_context, m_device, stagingBufferProperties);

//     stagingBuffer.loadData(0, imageSize, 0, pixels.data());

//     VulkanCommandBuffer tempCommandBuffer{ m_device,
...
// void VKImage::copyFromBuffer(VulkanBuffer& buffer, VulkanCommandBuffer&
// commandBuffer)
// {
//     VulkanBufferImageCopy region;
//     std::memset(&region, 0, sizeof(VulkanBufferImageCopy));
...
//     LOG_TRACE(
//       "vkCmdCopyBufferToImage region: {}/{}", m_imageData.width,
//       m_imageData.height
//     );
...
//   VulkanCommandBuffer& commandBuffer, [[maybe_unused]] VkFormat format,
...
//     clearMemory(&barrier);
//     barrier.sType                           =
//     VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER; barrier.oldLayout = oldLayout;
...
//     auto logicalDeviceHandle = m_device.getHandle();
//     auto memoryRequirements  = getMemoryRequirements(logicalDeviceHandle,
//     m_handle);
...
//       logicalDeviceHandle, &memoryAllocateInfo, m_context.getAllocator(),
//       &m_memory
//     ));
