...
// VulkanShaderStage::VulkanShaderStage(VulkanDevice& device, const Properties&
// props) :
...
//     if (m_handle)
//         vkDestroyShaderModule(m_device.logical.handle, m_handle,
//         m_device.allocator);
// }

// VulkanShader::VulkanShader(VulkanDevice& device, const Shader::Properties& props)
// :
//     Shader(props), m_device(device), m_requiredUboAlignment(0),
...
//     m_descriptorSetCount(0) { addAttributes(props.attributes);
...
//       m_device.logical.handle, globalSetBindingCount, descriptorWrites.data(), 0,
//       0
//     );
...
//     log::info("Minimal uniform buffer offset alignment={}",
//     m_requiredUboAlignment);
